...
export type Route = "/" | "/login" | "/trade" | "/wallet" | "/zk-verify" | "/testing" | "/admin" | "/admin/login";

const VALID_ROUTES: Route[] = ["/", "/login", "/trade", "/wallet", "/zk-verify", "/testing", "/admin", "/admin/login"];
